...
export default function Main() {
  ...
  return(
    <main className={'bg-white dark:bg-gray-500 flex flex-col items-center justify-center font-extrabold flex-1 px-4 xl:px-13 pt-5 pb-6.5'}>
